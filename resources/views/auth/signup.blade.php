...
<div class="signup-form">
    ...
    @csrf
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="first_name" class="form-control" id="" name="first_name" placeholder="First Name" required="required"></div>
				<div class="col"><input type="last_name" class="form-control" name="last_name" placeholder="Last Name" required="required"></div>
			</div>        	
        </div>
        <div class="form-group">
